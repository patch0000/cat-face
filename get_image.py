...
parser.add_argument('--data_dir',        type=str,   default=r'C:\work\py\cat\makeimage\NEGA_IMAGE')
parser.add_argument('--num_of_classes',  type=int,   default=1000)
parser.add_argument('--num_of_pics',   type=int,   default=1000)

args = parser.parse_args()

dict = {}
for line in open(r'C:\work\py\cat\makeimage\words.txt', 'r'):
    line = line.split()
    dict[line[0]] = line[1]
        ...
        try:
            ...
            while cnt < args.num_of_pics if args.num_of_pics < len(urls) else len(urls):
                ...
                try:
                    ...
                    cnt -= 1
                    print(e)
                # ValueError: unknown url type: '017.jpg'
